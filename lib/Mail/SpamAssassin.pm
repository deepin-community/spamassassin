...
if ('$LastChangedDate: 2021-04-09 00:54:52 -0700 (Fri, 09 Apr 2021) $' =~ ':') {
  # Subversion keyword "$LastChangedDate: 2021-04-09 00:54:52 -0700 (Fri, 09 Apr 2021) $" has been successfully expanded.
  # Doesn't happen with automated launchpad builds:
  # https://bugs.launchpad.net/launchpad/+bug/780916
  $SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2021-04-09 00:54:52 -0700 (Fri, 09 Apr 2021) $ updated by SVN'))[1];
}
